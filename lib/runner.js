...
SharkRunner.prototype = {
	...
	collectTasks: function *(tasksPath) {
		...
		try {
			...
			throw new VError(error, 'collectTasks readdir error');
		}
...
module.exports = {
	...
	runRequestedTasks:  shark.runRequestedTasks.bind(shark),
	runTask:            shark.runTask.bind(shark),
	collectTasks:       shark.collectTasks.bind(shark)
};